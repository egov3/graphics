...
export const ServerTechnicalWorks = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
    ...
    viewBox="0 0 160 160"
    fill="none"
    data-testid="ServerTechnicalWorksIllustration"
    {...props}
  >
    <path
    ...
    />
    <path
      d="M105.105 57L63 110.881H82.4223L74.8951 153L117 99.1186H97.5777L105.105 57Z"
      fill="#758393"
    />
  </svg>
);
